...
class BudgetProjection_dlg(QDialog):
    ...
    def loadBudgetProjection_thread(self, ctrl):
        ...
        self.projection = self.main_wnd.caller.rpcClient.getTorrentsProjection()
...
class Ui_BudgetProjectionDlg(object):
    def setupUi(self, BudgetProjectionDlg):
        ...
        ## row 1
        row = QHBoxLayout()
        self.availableBudget_label = QLabel("43200.0 QMC")
        ...
        ## row 4
        self.passingTorrents_label = QLabel("--")
        header_layout.addRow(QLabel("Passing Torrents: "), self.passingTorrents_label)
        ##
        header.setLayout(header_layout)
        layout.addWidget(header)
        ## LIST
        self.torrents_lst = QTableWidget()
        self.torrents_lst.setSelectionMode(QAbstractItemView.NoSelection)
        self.torrents_lst.setColumnCount(4)
        self.torrents_lst.setRowCount(0)
        self.torrents_lst.setShowGrid(True)
        self.torrents_lst.horizontalHeader().setSectionResizeMode(0, QHeaderView.Stretch)
        item = QTableWidgetItem("Name")
        item.setTextAlignment(Qt.AlignCenter)
        self.torrents_lst.setHorizontalHeaderItem(0, item)
        item = QTableWidgetItem("Allotted Budget")
        item.setTextAlignment(Qt.AlignCenter)
        self.torrents_lst.setHorizontalHeaderItem(1, item)
        item = QTableWidgetItem("Net Votes")
        item.setTextAlignment(Qt.AlignCenter)
        self.torrents_lst.setHorizontalHeaderItem(2, item)
        item = QTableWidgetItem("Total Allotted Budget")
        item.setTextAlignment(Qt.AlignCenter)
        self.torrents_lst.setHorizontalHeaderItem(3, item)
        self.torrents_lst.setColumnWidth(1, 130)
        self.torrents_lst.setColumnWidth(2, 130)
        self.torrents_lst.setColumnWidth(3, 160)
        layout.addWidget(self.torrents_lst)
        ## button ok
